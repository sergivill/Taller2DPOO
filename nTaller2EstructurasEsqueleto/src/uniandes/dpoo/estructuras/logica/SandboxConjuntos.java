...
public class SandboxConjuntos
{
    ...
    {
    	List<String> cadenaList = new ArrayList<>(arbolCadenas);
    	return cadenaList;
    }
    ...
    {
    	Iterator<String> iterator = arbolCadenas.descendingIterator();
        List<String> cadenaList = new ArrayList<>();
        while (iterator.hasNext()) {
            cadenaList.add(iterator.next());
        }
    ...
    {
    	String primeraCadena = arbolCadenas.last();
    	return primeraCadena;
    }
    ...
    {
    	NavigableSet<String> subSet = arbolCadenas.tailSet(cadena, true);
        Collection<String> siguientes = new ArrayList<>(subSet);
        return siguientes;
    }
    ...
    public void volverMayusculas( )
    {
        ...
        arbolCadenas.remove(cadena);
        arbolCadenas.add(cadenaMayuscula);
    	}
    }
    ...
    {
    	TreeSet<String> arbolCadenasInvertidas = new TreeSet<>(new Comparator<String>() {
            @Override
            public int compare(String s1, String s2) {
                return s2.compareTo(s1);
            };

        // Add all strings from the original set to the new set
        arbolCadenasInvertidas.addAll(arbolCadenas);

        
        return arbolCadenasInvertidas;
    }
